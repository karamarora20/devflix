...
export default function ProjectsCatalog({ projects, onProjectSelect }: ProjectsCatalogProps) {
  ...
  const filtered = projects.filter((p) => {
    const matchesGenre = selectedGenre === "All" || p.genres.includes(selectedGenre);
